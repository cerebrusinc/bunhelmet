...
declare function crossOriginEmbedderPolicy(
...
declare function crossOriginOpenerPolicy(
...
declare function crossOriginResourcePolicy(
	options?: Readonly<CrossOriginResourcePolicyOptions>
): (_req: IncomingMessage, res: ServerResponse, next: () => void) => void;

declare function originAgentCluster(): (
...
declare function referrerPolicy(
...
declare function strictTransportSecurity(
	options?: Readonly<StrictTransportSecurityOptions>
): (_req: IncomingMessage, res: ServerResponse, next: () => void) => void;

declare function xContentTypeOptions(): (
	_req: IncomingMessage,
	res: ServerResponse,
	next: () => void
) => void;
...
declare function xDnsPrefetchControl(
	options?: Readonly<XDnsPrefetchControlOptions>
): (_req: IncomingMessage, res: ServerResponse, next: () => void) => void;

declare function xDownloadOptions(): (
	_req: IncomingMessage,
	res: ServerResponse,
	next: () => void
) => void;
...
declare function xFrameOptions(
...
declare function xPermittedCrossDomainPolicies(
	options?: Readonly<XPermittedCrossDomainPoliciesOptions>
): (_req: IncomingMessage, res: ServerResponse, next: () => void) => void;

declare function xPoweredBy(): (
	_req: IncomingMessage,
	res: ServerResponse,
	next: () => void
) => void;

declare function xXssProtection(): (
	_req: IncomingMessage,
	res: ServerResponse,
	next: () => void
) => void;
