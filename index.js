...
function getMiddlewareFunctionsFromOptions(options) {
	...
	const strictTransportSecurityOption =
		(_a = options.strictTransportSecurity) !== null && _a !== void 0
			? _a
			: options.hsts;
	...
	const xContentTypeOptionsOption =
		(_b = options.xContentTypeOptions) !== null && _b !== void 0
			? _b
			: options.noSniff;
	...
	const xDnsPrefetchControlOption =
		(_c = options.xDnsPrefetchControl) !== null && _c !== void 0
			? _c
	...
	const xDownloadOptionsOption =
		(_d = options.xDownloadOptions) !== null && _d !== void 0
			? _d
			: options.ieNoOpen;
	...
	const xFrameOptionsOption =
		(_e = options.xFrameOptions) !== null && _e !== void 0
			? _e
			: options.frameguard;
	...
	const xPermittedCrossDomainPoliciesOption =
		(_f = options.xPermittedCrossDomainPolicies) !== null && _f !== void 0
			? _f
	...
	const xPoweredByOption =
		(_g = options.xPoweredBy) !== null && _g !== void 0
			? _g
	...
	const xXssProtectionOption =
		(_h = options.xXssProtection) !== null && _h !== void 0
			? _h
			: options.xssFilter;
...
const helmet = Object.assign(
	function helmet(options = {}) {
		...
		if (
			((_a = options.constructor) === null || _a === void 0
				? void 0
				: _a.name) === "IncomingMessage"
		) {
			throw new Error(
